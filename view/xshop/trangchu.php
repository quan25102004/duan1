...
<body>
  ...
  <!-- Banner -->
  <div class="banner">
    <img style="width: 100%; height: 500px;" src="pulic/img/dh6.jpg" alt>
  </div>
  <!-- BODY -->
  <div class="container">
    <div class="body">
      ...
      <div class=" row ">
        <?php for ($i = 0; $i <= 5; $i++) : ?>
          <div class=" col-lg-4 col-md-6 col-sm-12 mb-5" style="display: flex;justify-content: center;">
            <div class="product">
              <img src="pulic/img/<?= $sanpham[$i]['anh'] ?>" class="card-img-top" alt="..." style="height: 200px;width: 100%;;border-radius:10px;">
              <div class>
