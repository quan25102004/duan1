...
<body>
    ...
    <div class="container" style="display: flex;justify-content: flex-start;align-items: flex-start;">
        <div style="padding-right: 20%;">
            ...
            <form action="index.php?url=user&idKH=<?=$hienthi['idKH']?>" method='post' enctype="multipart/form-data">
                ...
                <div>
                    ...
                    <input type="password" disabled name="matKhau" value="<?=$hienthi['matKhau'] ?>"> 
