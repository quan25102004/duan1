      ...
      <div class="body1" style="width: 70%;">
        ...
        <hr>
          ...
          foreach ($chitietdonhang as $c) : ?>
            <div style="display: flex;">
              <div class="name_pro">
                ...
                <img style="box-shadow: 0 0 10px rgba(0, 0, 0);margin-bottom:10px;border-radius:10px;" src="pulic/img/<?= $c['anh'] ?>" alt width="100px">
          ...
          <div style="display: flex;justify-content: space-between;">
            <div class="block1">
              <div style="display: flex;">
                <p style="color: #8e8d8d;font-weight: bold;">Trạng thái đơn hàng: </p>
                <p style="color: red;font-weight: bold;padding-left: 5px;"><?=$donhang['tenTT']?></p>
              </div>
              <p style="color: #8e8d8d;font-weight: bold;">Thông tin giao hàng</p>
              <ul>
                <form action="?url=xoadonhang_xshop&idDH=<?=$donhang['idDH']?>" method='post'>
                  <li style="font-weight: bold;">Tên người nhận: <i style="color: #8e8d8d;font-weight: 500;"><?= $donhang['tenKH'] ?></i></li>
                  <li style="font-weight: bold;">Số điện thoại: <i style="color: #8e8d8d;font-weight: 500;"><?= $donhang['sdt'] ?></i></li>
                  <li style="font-weight: bold;">Địa chỉ: <i style="color: #8e8d8d;font-weight: 500;"><?= $donhang['diachi'] ?></i></li>
                  <p style="color:red"><?= $error['diachi'] ?? '' ?></p>
              </ul>
              <div class="delete_DH" style="margin-top: 50px;">
              <!-- <a href="?url=xoadonhang_xshop&idDH=<?=$donhang['idDH']?>&idTT=<?=$donhang['idTT']?>&huy" name='huydonhang'><input style="padding:2px 5px;background-color: #646a6f;color: #f1f0f0;font-weight: 600;border: #f1f0f0;border-radius: 2px;" type="submit" name="huydonhang" value="Hủy đơn hàng"></a> -->
                
                <input type="hidden" name='idTT' value="<?=$d['idTT']?>">
              </div>
              </form>
            ...
            <div class="block2" style="width: 45%;margin-top: 5%;margin-bottom: 5%;">
              <div style="padding: 30px; background-color: #f1f0f0;">
                ...
                <div style="margin-top: 10px;">
                  <div style="display: flex;justify-content: space-between;">
                    <p>Tổng sản phẩm</p>
                    <p style="color: #f24261;font-weight: bold;"><?= number_format($donhang['tongsp'], 0, ',', '.') ?></p>

                  </div>
                  <div style="display: flex;justify-content: space-between;">
                    <p>Tổng tiền hàng</p>
                    <p style="color: #f24261;font-weight: bold;"><?= number_format($donhang['thanhtien'], 0, ',', '.') ?></p>
                  </div>
                  <div style="display: flex;justify-content: space-between;">
                    <p>Thành tiền</p>
                    <p style="color: #f24261;font-weight: bold;"><?= number_format($donhang['thanhtien'], 0, ',', '.') ?> VNĐ</p>
                  </div>
                </div>
